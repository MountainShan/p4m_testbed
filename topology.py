...
def main():
	...
	# Topology
	for i in range(0,4):
		net.addLink(HostList[i], P4SwitchList[i], bw=10)
	
	net.addLink(P4SwitchList[0], P4SwitchList[1], bw=10)
	net.addLink(P4SwitchList[0], P4SwitchList[2], bw=10)
	net.addLink(P4SwitchList[0], P4SwitchList[3], bw=10)
	net.addLink(P4SwitchList[1], P4SwitchList[2], bw=10)
	net.addLink(P4SwitchList[1], P4SwitchList[3], bw=10)
